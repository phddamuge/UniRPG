...
#     pdb.set_trace()
    ...
    return table_cell_tokens, table_split_cell_tokens, table_ids, table_cell_number_value, table_cell_index,       table_row_header_index, table_col_header_index, table_data_cell_index,same_row_data_cell_rel, same_col_data_cell_rel, data_cell_row_rel, data_cell_col_rel, table_cell_number_value_with_time, row_include_cells, col_include_cells, all_cell_index, all_cell_token_index
...
def paragraph_tokenize(question, paragraphs, tokenizer):
    ...
    ## concat multi-paragraph into a paragraph
    paragraph_text = ""
    for order in sorted_order:
        paragraph_text+=paragraphs[order] + ' '
    ...
    import pdb
#     pdb.set_trace()
    return tokens, split_tokens, sub_token_offsets, paragraph_text,  paragraph_ids,  word_piece_mask, number_mask, number_value, paragraph_index
...
def _concat(question_ids,
            ...
            paragraph_split_tokens_offsets,
            paragraph_text,
...
#     pdb.set_trace()
    ...
    same_col_data_cell_rel, data_cell_row_rel,data_cell_col_rel,table_cell_number_value_with_time, row_include_cells, col_include_cells, all_cell_index, all_cell_token_index=clip_table(max_cell_num,table_row_header_index, 
...
#             pdb.set_trace()
            ## trunc
            paragrah_token_num = passage_length_limitation-len(table_ids) - 1
            paragraph_split_tokens_offsets = paragraph_split_tokens_offsets[:paragrah_token_num]
            paragraph_text = paragraph_text[:paragraph_split_tokens_offsets[-1][1]]
            table_length = len(table_ids)
...
#     pdb.set_trace()
    ...
    return input_ids, input_ids_list, input_tokens, question_mask, attention_mask, paragraph_mask, paragraph_number_value, paragraph_index, paragraph_split_tokens_offsets, paragraph_text,\
           table_mask, table_cell_number_value, table_index, input_segments, table_row_header_index,table_col_header_index, table_data_cell_index,same_row_data_cell_rel,\
...
def clip_table(max_table_cell_num, table_row_header_index, table_col_header_index, table_data_cell_index, same_row_data_cell_rel, same_col_data_cell_rel, data_cell_row_rel, data_cell_col_rel,table_cell_number_value_with_time, row_include_cells, col_include_cells, all_cell_index, all_cell_token_index):
    '''
...
#     pdb.set_trace()
    ...
    return table_row_header_index, table_col_header_index,table_data_cell_index,same_row_data_cell_rel, same_col_data_cell_rel, data_cell_row_rel, data_cell_col_rel, table_cell_number_value_with_time,row_include_cells, col_include_cells, all_cell_index, all_cell_token_index

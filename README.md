...
This is code for the EMNLP 2022 Paper "UniRPG: Unified Discrete Reasoning over Table and Text as Program Generation".  It is based on the repository [TAT-QA](https://github.com/NExTplusplus/TAT-QA}).
